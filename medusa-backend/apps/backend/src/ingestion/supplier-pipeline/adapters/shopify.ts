...
export const shopifyAdapter: SupplierProductAdapter = {
  ...
  matches: (candidate: ProductPageCandidate) =>
    ...
    /(^|\.)jmudental\.com/i.test(candidate.url) ||
    /american dental accessories|carolina dental supply|ddi supply|dental distributors|jmu dental/i.test(candidate.distributor),
