...
export const shopifyAdapter: SupplierProductAdapter = {
  ...
  matches: (candidate: ProductPageCandidate) =>
    ...
    /(^|\.)bitesupply\.com/i.test(candidate.url) ||
    /american dental accessories|carolina dental supply|ddi supply|dental distributors|bite supply/i.test(candidate.distributor),
